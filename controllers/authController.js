...
//https://sleepy-badlands-23438.herokuapp.com/
//https://glacial-thicket-90326.herokuapp.com/
      ...
      .then((hash) => {
        db("users")
          ...
          .then((user) => {
            ...
            let msg = `Dear User, Welcome to Az-crypto Investment. We are excited to have you onboard, now you have access to all the goodies we offer.
\nRegards, 
\nAz-crypto Investment`;
            let html = `<div> <div> Dear User,<div/>
              <div>Welcome to Az-crypto Investment. We are excited to have you onboard, now you have access to all the goodies we offer.</div>


<div style="padding-top:70px">Regards,<div/>
<div>Az-crypto Investment<div/> <div/>`;
...
module.exports.approve = async (req, res) => {
  ...
  try {
    ...
    \nThank you for choosing Az-crypto Investment. For complaints or inquires, do not hesitate to contact our 24/7 support team via email: support@Az-crypto Investment .com\n
...
module.exports.wapprove = async (req, res) => {
  ...
  try {
    ...
    \nThank you for choosing Az-crypto Investment . For complaints or inquires, do not hesitate to contact our 24/7 support team via email: support@Az-crypto Investment \n
  ...
  try {
    let transporter = nodemailer.createTransport({
      ...
      auth: {
        ...
        pass: "defsnoworlater$12", // generated ethereal password
      },
    });

    let info = await transporter.sendMail({
      from: '"Az-crypto Investment" <support@azcryptocoins.com>', // sender address
